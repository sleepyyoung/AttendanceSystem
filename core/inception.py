...
from tensorflow.keras.layers import Activation, BatchNormalization, Concatenate, Conv2D, Dense, Dropout, \
    GlobalAveragePooling2D, Input, Lambda, MaxPooling2D, add
